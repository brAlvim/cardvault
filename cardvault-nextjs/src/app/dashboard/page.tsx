    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`bg-blue-800 text-white ${sidebarOpen ? 'w-64' : 'w-20'} transition-all duration-300 ease-in-out`}>
        ...
        <nav className="mt-8">
          <div className="px-4 mb-6">
            ...
            <ul className="mt-3">
              <li className="mb-2">
                <Link href="/dashboard" className="flex items-center py-2 px-4 bg-blue-700 rounded-md">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h2 className="text-sm font-medium text-gray-600">Gift Cards</h2>
              ...
              <div className="mt-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-gray-500 text-sm">Desde o último mês</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h2 className="text-sm font-medium text-gray-600">Fornecedores</h2>
                  <p className="text-2xl font-semibold text-gray-800">18</p>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex items-center">
                  <span className="text-green-500 text-sm font-medium">+2.0%</span>
                  <span className="ml-2 text-gray-500 text-sm">Desde o último mês</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h2 className="text-sm font-medium text-gray-600">Transações</h2>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h2 className="text-sm font-medium text-gray-600">Saldo Disponível</h2>
                  <p className="text-2xl font-semibold text-gray-800">R$ 12.450</p>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex items-center">
          ...
          {/* Charts and<response clipped><NOTE>To save on context only part of this file has been shown to you. You should retry this tool after you have searched inside the file with `grep -n` in order to find the line numbers of what you are looking for.</NOTE>
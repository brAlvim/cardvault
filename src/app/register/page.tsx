  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h1 className="text-center text-3xl font-bold text-blue-600">CardVault</h1>
        <h2 className="mt-2 text-center text-2xl font-bold text-gray-900">Crie sua conta</h2>
      </div>
